...
namespace NW
{
	...
	public:
		...
		void MoveBy(int x, int y, bool repaint = true);
		void MoveTo(int x, int y, bool repaint = true);
		void ResizeBy(int width, int height, bool repaint = true);
		void ResizeTo(int width, int height, bool repaint = true);
